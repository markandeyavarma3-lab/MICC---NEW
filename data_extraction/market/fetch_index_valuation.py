...
INDICES = [
    ...
    "NIFTY MIDCAP 100", "NIFTY SMLCAP 100", "NIFTY BANK", "NIFTY IT",
    "NIFTY AUTO", "NIFTY FMCG", "NIFTY PHARMA", "NIFTY METAL", "NIFTY ENERGY",
    "NIFTY REALTY", "NIFTY INFRA", "NIFTY MEDIA", "NIFTY PSU BANK",
    "NIFTY PVT BANK", "NIFTY FIN SERVICE", "NIFTY HEALTHCARE",
]
