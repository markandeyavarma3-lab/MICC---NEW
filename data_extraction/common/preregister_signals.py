...
REGISTRY = [
    ...
    ("value_ep",
     "monthly rank-IC of as-of E/P (screener EPS / adj close) vs fwd_ret_1m, top-500 liquid",
     "2015->present (PIT depth), months with >=100 names; re-run with depth growth",
     "mean IC>0 AND t>=3.0 AND H2>0",
     "context; cap-lift additionally needs human approval EVEN on a pass (survivorship caveat)",
     "context", "FAILED 2026-07: IC +0.005, t=0.48 over 131 months despite survivor tailwind"),
    ("quality_margin",
     "monthly rank-IC of as-of OPM%/FinancingMargin% vs fwd_ret_1m",
     "2015->present, months with >=100 names",
     "mean IC>0 AND t>=3.0 AND H2>0",
     "context",
     "context", "FAILED 2026-07: IC -0.003, t=-0.26"),
    ("quality_growth",
     "monthly rank-IC of as-of 3-FY Net Profit growth vs fwd_ret_1m",
     "2015->present, months with >=100 names",
     "mean IC>0 AND t>=3.0 AND H2>0",
     "context",
     "context", "FAILED 2026-07: IC +0.001, t=0.12"),
